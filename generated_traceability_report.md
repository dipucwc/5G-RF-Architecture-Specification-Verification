# Generated RF Requirement Traceability Report

This report was generated by `tools/traceability_checker.py`.

| Requirement ID | Domain | Test Case | Metric | Measured | Limit | Result | Evidence |
|---|---|---|---|---:|---:|---|---|
| RF-BF-REQ-001 | Beamforming | TC-BF-001 | beam_gain_delta | 0.72 dB | <= 1 dB | PASS | reports/beam_gain_phase_summary.md |
| RF-BFC-REQ-001 | BFC | TC-BFC-001 | residual_phase_error | 2.1 deg | <= 3 deg | PASS | reports/bfc_residual_error_table.md |
...
- Requirements with verification cases: 7
- Requirement coverage: 100.0%
- Requirements passing current results: 7
- Pass rate: 100.0%

No missing traceability items were found.
